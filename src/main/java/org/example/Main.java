...
class Student {
    ...
    /**
     * Creates an id using a number from 1-4 given by the user and a random string of length 4.
     */
    private void makeID()
    {
        String grade;
    ...
    /**
     * Returns a randomly generated 4 character string that will be combined with a number entered by the user to make the student id.
     ...
     *A list that contains the classes a student has at the moment.
     *A number that represent a particular class.
     */
     ...
     * The list containing the student's current classes
     * The string that being checked to see if it is unique in the list
     * Whether the string is already in the list  or not
     */
